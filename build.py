...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ci.geofencing.js')
	...
	f = os.path.join(cwd,'Classes','CiGeofencingModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ci.geofencing.js']
